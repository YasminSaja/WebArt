...
<head>
    ...
    <title>Category - CreateTopia</title>
...
<div class="w-full h-2 bg-[#65c4d2] mb-[17px]"></div>
    ...
    <script>
        ...
        function filterCategory(type) {
            ...
            const traditional =
                document.getElementById('traditionalBtn');

            const digital =
                document.getElementById('digitalBtn');


            if (type === 'traditional') {

                traditional.classList.add('bg-[#eadff7]');
                traditional.classList.remove('bg-white');

                digital.classList.add('bg-white');
                digital.classList.remove('bg-[#eadff7]');
            ...
            if (type === 'digital') {
                ...
                digital.classList.add('bg-[#eadff7]');
                digital.classList.remove('bg-white');

                traditional.classList.add('bg-white');
                traditional.classList.remove('bg-[#eadff7]');
